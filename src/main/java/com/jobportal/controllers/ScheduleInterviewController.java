...
public class ScheduleInterviewController {
    ...
    private void loadCandidates() {
        ...
        List<Candidate> candidates = candidateService.getCandidatesByRecruiter(recruiterEmail);
        ObservableList<String> candidateNames = FXCollections.observableArrayList();
        
        for (Candidate candidate : candidates) {
            candidateNames.add(candidate.getName() + " (" + candidate.getEmail() + ")");
        }
    ...
    private void handleSchedule() {
        ...
        // Extract candidate email from combo box value
        String candidateInfo = candidateComboBox.getValue();
        String candidateEmail = candidateInfo.substring(candidateInfo.indexOf("(") + 1, candidateInfo.indexOf(")"));

        // Create interview object
        Interview interview = new Interview(
            null, // ID will be generated by service
            candidateInfo.substring(0, candidateInfo.indexOf("(")).trim(),
            candidateEmail,
